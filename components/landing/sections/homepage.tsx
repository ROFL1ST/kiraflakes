...
export default function Hero({ data }: { data?: any }) {
  ...
  const text = data?.display_name || "Kiraflakes";
                ...
                <div className="text-center">
                  ...
                  >
                    ...
                    >
                      {data?.avatar_url ? (
                        <Image
                          ...
                          width={120}
                          height={120}
                          className="mx-auto h-30 w-auto rounded-full object-cover aspect-square"
                        />
                      ) : Tamalogo && (
                        <Image
                          src={Tamalogo}
                    ...
                    <div className="text-center mt-4">
                      ...
                      >
                        {data?.bio || "hii! my name is kira (or tama) she/her | uni student! take a look around"}
                      </motion.p>
                    </div>
                  </motion.div>
                  {/* BUTTON */}
