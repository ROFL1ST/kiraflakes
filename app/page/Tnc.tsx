...
import Ilust2 from "../assets/ilust2.png";
          ...
          <div className="flex flex-wrap w-full">
            <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
              <div className="flex relative pb-12">
                ...
                <div className="shrink-0 w-10 h-10 rounded-full bg-white inline-flex items-center justify-center text-[#E36464] relative z-10">
                  <svg
                    fill="none"
                    stroke="currentColor"
